...
window.location.href="income_list.php?month="+val+"&year="+document.getElementById('year').value;
}
function year(val){

window.location.href="income_list.php?month="+document.getElementById('month').value+"&year="+val;
}

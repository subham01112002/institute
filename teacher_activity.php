<?php 
    ...
    if(!empty($_REQUEST['add']) && !empty($_REQUEST['mode'])){
      ...
      if($add)
        {
          @header("Location: teacher_activity.php?msg=Successfull Insert");
		      exit();  
        }
    }
      ...
      if($sub)
        {
          ...
          unset($_SESSION['cid']);
          session_destroy();
          @header("Location: teacher.php?msg=Successfull Insert");
		      exit();  
        }
    }
...
<h1><a href="index.php"><i class="fa-solid fa-building-columns"></i></a></h1>
  ...
  <form action="" name="teacherform" id="teacherform" method="post" onSubmit="return checking();">
    ...
    <div class="form-group">
      ...
      <input class="form-control" id="Teacher_id" type="text" name="Teacher_id" value="<?php echo $name ?>"/> 
    </div>
    <div class="form-group">
